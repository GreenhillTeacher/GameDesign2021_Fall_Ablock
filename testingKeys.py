...
# load the image
gameIcon = pygame.image.load("Pygame-Tutorials-master\Game\L1.png")

# set icon
pygame.display.set_icon(gameIcon)

# load the image
backgroundImg = pygame.image.load("Pygame-Tutorials-master\Game\\bg.jpg")

# load the image
playerImage = pygame.image.load("Pygame-Tutorials-master\Game\standing.png")
...
# load the image
blockImage = pygame.image.load("Pygame-Tutorials-master\Game\L1.png")
